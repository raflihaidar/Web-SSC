<template>
    <svg class="svg-inline--fa fa-square-check h-[1em]" aria-hidden="true" focusable="false" data-prefix="far"
        data-icon="square-check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
